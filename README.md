...
Szczegółowe testy znajdują się w pliku [Wybor_wspolczynnika_oversamplingu.ipnb](Wybor_wspolczynnika_oversamplingu.ipynb).
...
Szczegółowe testy znajdują się w pliku [Wybor_metody_redukcji_wymiarow.ipnb](Wybor_metody_redukcji_wymiarow.ipynb)
...
Szczegółowe testy znajdują się w pliku [Wybor_liczby_cech.ipnb](Wybor_liczby_cech.ipynb).
...
Szczegółowe testy znajdują się w pliku [Wybor_funkcji_aktywacji.ipnb](Wybor_funkcji_aktywacji.ipynb).
...
Szczegółowe testy znajdują się w pliku [Wybor_optymalizatora.ipnb](Wybor_optymalizatora.ipynb).
...
Szczegółowe testy znajdują się w pliku [Wybor_liczby_neuronow.ipnb](Wybor_liczby_neuronow.ipynb).

## Testy modelu
Gotowy model z dobranymi parametrami przetestowano szczegółowo w pliku [Testy_modelu.ipnb](Testy_modelu.ipynb). Znajdują się tam także wykresy charakterystyki ROC, które wskazują, że model zwykle bardzo "pewnie" przewiduje wyniki. Prawdopodobnie wynika to z charakterystyki zbioru danych, lub samego problemu który może nie być odpowiedni dla machine learningu.
